...
for planet in planetDATA:
    system.add(getdata(planet))
print("READY")
system.add(getdata(301))
system.add(CelestialBody(system.directory[3].pos, (system.directory[3].v + norm(system.directory[3].v) * 16.5E3), 100, "THINGY"))
system.directory[len(system.directory)-1].color = (0, 0, 255)
